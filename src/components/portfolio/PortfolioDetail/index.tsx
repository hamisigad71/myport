        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex md:flex-row flex-col items-start w-full justify-between flex-wrap sm:flex-nowrap lg:gap-0 gap-8">
            <div className="lg:w-[60%] w-full">
              <div className="pb-14">
                <p className="md:text-[1.6875rem] text-[1.0625rem] md:leading-9 leading-8 font-normal text-midnight_tex dark:text-white">
              ...
              <div className="flex items-start justify-between sm:flex-row flex-col lg:gap-0 gap-4">
                <p className="sm:text-lg text-base font-normal text-secondary max-w-xs dark:text-white/50">

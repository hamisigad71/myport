...
const Footer: FC = () => {
  return (
    <footer className="bg-darkmode relative z-1 border-t border-dark_border px-6">
      <div className="container mx-auto max-w-6xl lg:max-w-7xl px-4">
        <div className="grid md:grid-cols-12 grid-cols-1 sm:grid-cols-12">
          <div className="md:col-span-4 sm:col-span-6 col-span-12 sm:border-r border-b border-solid border-dark_border flex items-center sm:border-b-0 sm:min-h-25 py-10 lg:py-14 xl:py-16 shrink-0">
            <div className="sm:content-normal sm:text-start text-center content-center sm:w-auto w-full">
              ...
              >
                <Image
                  ...
                  quality={100}
                  unoptimized
                  className="mx-auto lg:mx-0 lg:max-w-[180px] h-auto"
                />
              </Link>
              <h2 className="text-white py-10 text-[32px] md:text-[36px] lg:text-[40px] leading-tight font-bold">
          ...
          <div className="md:col-span-4 sm:col-span-6 col-span-12 sm:flex items-center sm:min-h-25 py-10 lg:py-14 xl:py-16 justify-center shrink-0 md:border-r border-b sm:border-b-0 border-solid border-dark_border">
          ...
          <div className="md:col-span-4 col-span-12 border-t md:border-none border-solid border-dark_border sm:flex items-center justify-end md:min-h-25 py-10 lg:py-14 xl:py-16 shrink-0">
            <div className="md:w-3/4 w-full sm:text-start text-center">
              ...
              <form className="newsletter-form flex rounded-lg sm:w-full w-3/4 sm:mx-0 mx-auto">
                <input
                  type="email"
                  placeholder="Email*"
                  className="p-4 text-base border-transparent rounded-s-lg rounded-e-none! outline-0 focus:border-primary dark:focus:border-primary w-[calc(100%-137px)] flex bg-white dark:bg-midnight_text dark:text-white dark:border-solid dark:border dark:border-border_color"
                />
                <button
                  type="submit"
                  className="p-2.5 text-base font-medium bg-primary text-white border-none cursor-pointer rounded-e-lg outline-0 text-center w-36 hover:bg-blue-700 hover:shadow-none"
                >
                  Subscribe
                </button>
              </form>
